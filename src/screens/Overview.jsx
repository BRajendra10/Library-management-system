  ...
  return (
    <div className="w-full h-full">
      <div className="w-full h-fit grid grid-cols-12 grid-rows-35 gap-5 p-3">
        ...
        <div className="col-span-12 row-span-25 grid grid-cols-2 gap-5">

          {/* Overdue section */}
          <section className="h-full border border-blue-200 rounded-lg overflow-scroll">
          ...
          <section className="border border-blue-200 rounded-lg">
